 ...
 * [SolrUnknownFieldTypeInspection] already reports — in the platform's vocabulary rather than
...
internal class SolrFieldTypeReference(element: XmlAttributeValue) :
     ...
     *
     * Completion for this position is contributed by [SolrConfigsetCompletionContributor], which can
