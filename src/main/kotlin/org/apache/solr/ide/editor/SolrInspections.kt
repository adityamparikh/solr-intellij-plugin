...
internal object SolrInspections {
    ...
    /**
     * The model for [file], or null when nothing should be inspected.
     *
     * Null outside a configset, which is also null outside a project depending on a Solr client —
     * the activation gate is upstream of every inspection rather than repeated in each one.
     */
