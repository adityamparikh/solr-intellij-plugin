...
internal object SolrInspections {
     ...
     *
     * **Shared because the rule about staying quiet is the part worth having in one place.** Two
        ...
        return object : XmlElementVisitor() {
            override fun visitXmlTag(tag: XmlTag) {
                for (occurrence in SolrConfigParameters.fieldNameOccurrences(tag)) {
                    ...
                    if (!isCheckableFieldName(occurrence.fieldName)) continue
